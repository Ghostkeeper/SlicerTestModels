...
assert(min_width * windings < max_radius); //Don't let spirals self-overlap in the centre.
assert(max_width * windings < max_radius); //Don't let spirals self-overlap towards the edge.
